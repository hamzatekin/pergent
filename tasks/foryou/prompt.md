...
- `context`: only when the post makes no sense without background you are sure of (who a person is, what an ongoing story is). Two sentences at most. Leave it out otherwise.
